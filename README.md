...
O projeto foi dividido em três partes intensivas (semana 1, semana 2, semanas 3 e 4), cobrindo todo o ciclo de vida de um projeto de dados em ambiente de Big Data.
